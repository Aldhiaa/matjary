        ...
        <div class="form-group quantity">
            <div class="d-flex radio-check ">
                <div class="form-check form-check-inline form-group col-md-6">
                    ...
                    <label class="form-check-label" for="plus_quantity"><?php echo e(__('Add Quantity')); ?></label>
                </div>
                <div class="form-check form-check-inline form-group col-md-6">
                    <input type="radio" id="minus_quantity" value="Less" name="quantity_type" class="form-check-input">
                    <label class="form-check-label" for="minus_quantity"><?php echo e(__('Less Quantity')); ?></label>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\matjar\resources\views/productstock/edit.blade.php ENDPATH**/ ?>