                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        ...
                                        <?php echo e(Form::label('start_month', __('Start Month'), ['class' => 'text-type'])); ?>
                                            ...
                                            <?php echo e(Form::month('start_month',null,array('class'=>'month-btn form-control','placeholder'=>'Start Month'))); ?>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        ...
                                        <?php echo e(Form::label('end_month', __('End Month'), ['class' => 'text-type'])); ?>
                                            ...
                                            <?php echo e(Form::month('end_month',null,array('class'=>'month-btn form-control','placeholder'=>'Start Month'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\matjar\resources\views/transaction/index.blade.php ENDPATH**/ ?>